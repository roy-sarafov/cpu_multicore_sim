...
# File:    imem2.asm (mulparallel - Core 2)
#
# Description:
# Parallel Matrix Multiplication (16x16).
# Core 2 is assigned to calculate Rows 8 through 11 of the result Matrix C.
# ==============================================================================

# --- PHASE 1: INITIALIZATION ---
# Set the row processing range for Core 2.
add $r2, $zero, $imm, 8         # Initialize i = 8 (Start Row for Core 2)
add $r12, $zero, $imm, 12       # Set Row Limit = 12 (Processes rows 8, 9, 10, 11)

loop_i:
    # Check for completion of the assigned row block.
    beq $imm, $r2, $r12, flush_start # If i reaches 12, jump to cache flush
...
halt_core:
    halt $zero, $zero, $zero, 0 # Terminate Core 2