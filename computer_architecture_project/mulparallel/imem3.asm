...
# File:    imem3.asm (mulparallel - Core 3)
#
# Description:
# Parallel Matrix Multiplication (16x16).
# Core 3 is assigned to calculate Rows 12 through 15 of the result Matrix C.
# ==============================================================================

# --- PHASE 1: INITIALIZATION ---
# Set the row processing range for Core 3.
add $r2, $zero, $imm, 12        # Initialize i = 12 (Start Row for Core 3)
add $r12, $zero, $imm, 16       # Set Row Limit = 16 (Processes rows 12, 13, 14, 15)

loop_i:
    # Check for completion of the assigned row block.
    beq $imm, $r2, $r12, flush_start # If i reaches 16, jump to cache flush
...
halt_core:
    halt $zero, $zero, $zero, 0 # Terminate Core 3