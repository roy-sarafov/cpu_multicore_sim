...
# File:    mulparallel/imem0.asm
# Author:
# ID:
# Date:    11/11/2024
#
# Description:
# Parallel Matrix Multiplication (16x16) - Core 0.
# Core 0 processes rows 0 to 3.
# ==============================================================================
...
# ------------------------------------------------------------------------------
    ...
    add $r2, $zero, $imm, 0     # Start i = 0
    add $r15, $zero, $imm, 4    # Stop i = 4 (exclusive)

# ------------------------------------------------------------------------------
# OUTER LOOP (Rows 0-3)
# ------------------------------------------------------------------------------
LoopI:
    beq $r2, $r15, $imm, Done   # Stop when i == 4
